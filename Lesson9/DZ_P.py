...
class Pizza:
    ...
    def __init__(self, ingredients: list[str], size: str, base_price: float):
        self._size = size
    ...
    def add_ingredients(self, ingredients):
        if len(ingredients) < 10:
            ...
            print("Ингредиентвов не может быть больше 10")
            return ["Сыр"]
...
class SmallPizza(Pizza):
    def __init__(self, ingredients,size="small", base_price=10):
         super().__init__(ingredients, size, base_price)
